...
import com.jeffd76.lunchpail_delight.item.FoodSlot;
...
public class LunchpailMenu extends AbstractContainerMenu {
    private final int slotCount;
    private final int containerSlot;

    public LunchpailMenu(int containerId, Inventory playerInventory, ItemStack canteenStack) {
        super(LunchpailDelight.LUNCHPAIL_MENU.get(), containerId);

        LunchpailItem lunchpailItem = (LunchpailItem) canteenStack.getItem();
        this.slotCount = lunchpailItem.getSlotCount();
        ...
        if (handler != null) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                this.addSlot(new FoodSlot(handler, i, 8 + xOffset + col * 18, 18 + row * 18));
            }
        }
    ...
    public LunchpailMenu(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf data) {
    ...
    public boolean stillValid(Player player) {
        ...
        return mainHand.getItem() instanceof LunchpailItem || offHand.getItem() instanceof LunchpailItem;
    }
